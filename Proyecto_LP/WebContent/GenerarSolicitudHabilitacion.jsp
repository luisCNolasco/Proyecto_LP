...
<body>
  <form>
    ...
    <div class="form-group row">
      <label for="codigoSolicitud" class="col-sm-4 col-form-label">Código de solicitud</label>
      <div class="col-sm-6">
        <input type="text" class="form-control" name="codigoSolicitud" />
      </div>
    </div>
    <div class="form-group row">
      <label for="codigoSolicitante" class="col-sm-4 col-form-label">Código de solicitante</label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      <label for="requerimientos" class="col-sm-4 col-form-label" id="requerimiento">Informe técnico
      </label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      <label for="requerimientos" class="col-sm-4 col-form-label" id="requerimiento">Informe cotización
      </label>
      <div class="col-sm-6">
        <input id="" type="text" class="form-control" name="requerimiento" />
      </div>
    ...
    <div class="form-group row">
      <label for="requerimientos" class="col-sm-4 col-form-label" id="requerimiento">Habilitación presupuestal</label>
      <div class="col-sm-6">
        <input id="" type="text" class="form-control" name="requerimiento" />
      </div>
